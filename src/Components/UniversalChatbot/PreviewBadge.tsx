  ...
  <Popover
    bodyContent={
      <>
        ...
        <p>
          Preview features have limitations on support compared to fully released features. They are not intended for production workloads and are not
          covered by standard Red Hat Customer Portal case management.
        </p>
    ...
    zIndex={999999}
  >
    <Label style={{ cursor: 'pointer' }} color="orange" icon={<InfoCircleIcon />} isCompact onClick={(e) => e.stopPropagation()}>
      Preview
    </Label>
  </Popover>
);
