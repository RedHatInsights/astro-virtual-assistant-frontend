    ...
    <>
        {
            ...
            <TextContent className="banner__create-service-account">
                ...
                >
                    <p><b>${message.additionalContent[0]}</b></p>
                    <p>${message.additionalContent[1]}</p>
                    <p>Client Id: <b>${message.additionalContent[2]}</b></p>
                    <p>Secret: <b>${message.additionalContent[3]}</b></p>
...
export const CreateServiceAccFailedBanner: FunctionComponent<MessageProps<Banner>> = ({ message }) => {
    return (
        <>
            <TextContent className="banner__create-service-account">
                <Alert
