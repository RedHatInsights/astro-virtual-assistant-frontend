...
describe('UniversalModelSelection Component', () => {
  ...
  const TestWrapper = ({ children }: { children: React.ReactNode }) => (
    <UniversalChatbotContext.Provider value={mockContextValue}>{children}</UniversalChatbotContext.Provider>
  );
  ...
  it('should call setCurrentModel when a different model is selected', () => {
    ...
    cy.wrap(mockSetCurrentModel).should('have.been.calledWith', 'rhel');
  });
  ...
  it('should have proper accessibility attributes', () => {
    ...
    cy.get('.universal-model-selection__toggle').should('have.attr', 'aria-expanded', 'false');

    // Open dropdown
    cy.get('.universal-model-selection__toggle').click();

    // Toggle should show expanded state
    cy.get('.universal-model-selection__toggle').should('have.attr', 'aria-expanded', 'true');
  ...
  it('should update display when model prop changes', () => {
    ...
    const UpdatedTestWrapper = ({ children }: { children: React.ReactNode }) => (
      <UniversalChatbotContext.Provider value={updatedContextValue}>{children}</UniversalChatbotContext.Provider>
    );
